...
if (!empty($_SESSION['role'])) {
    ...
    $getUsers = new logics();
    $verification = $getUsers->SubmittedTasks();
                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-12">
                                <div class="card-body" style="overflow-x: scroll;">
                                    <h5 class="card-title text-primary">View All Submitted Tasks</h5>
                                    <br>
                                    <table id="example" class="table table-bordered">
                                        ...
                                        for ($i = 0; $i < $verification['count']; $i++) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo $verification['url'][$i]; ?>" target="_blank"><?php echo $verification['url'][$i]; ?></a></td>
