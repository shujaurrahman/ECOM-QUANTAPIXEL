...
if (!empty($_SESSION['role'])) {
    ...
    $getUsers = new logics();
    $verification = $getUsers->getRegistrations();
                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-12">
                                <div class="card-body" style="overflow-x: scroll;">
                                    <h5 class="card-title text-primary">View All the Registrations</h5>
                                    <br>
                                    <?php
                                    ...
                                    <table id="example" class="table table-bordered">
                                        ...
                                        for ($i = 0; $i < $verification['count']; $i++) {
                                            ?>
                                            <tr>
                                                <td><a href="reg_status.php?id=<?php echo $verification['sno'][$i]; ?>&status=Inactive" class="btn btn-sm btn-outline-success">Active</a></td>
                                                <td><?php echo $i + 1; ?></td>
