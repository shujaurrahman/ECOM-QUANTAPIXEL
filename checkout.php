...
if(isset($_POST['submit'])) {
    ...
    try {
        ...
        $verification = $adminObj->PlaceOrder($_SESSION['user_id'],$_POST['name'],$_POST['email'],$_POST['mobile'],$_POST['address1'],$_POST['address2'],$_POST['city'],$_POST['state'],$_POST['pincode'],$_POST['shipping_name'],$_POST['shipping_email'],$_POST['shipping_mobile'],$_POST['shipping_address1'],$_POST['shipping_address2'],$_POST['shipping_city'],$_POST['shipping_state'],$_POST['shipping_pincode'],$_POST['total_products'],$_POST['subtotal'],$_POST['gst'],$_POST['total'],$grandTotal_hidden,$_POST['coupon_hidden'],$_POST['discount_hidden'],$_POST['couponType_hidden'],$_POST['payment_mode'],$_POST['payment_amount'],$_POST['payment_reference'],$payment_proofName  );
